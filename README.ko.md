...
**English**: [README.md](README.md) · **한국어**: README.ko.md (이 문서)
...
> 이 repo는 수업 콘텐츠와 **분리된 별도 디렉터리**다 (기본 위치 `~/Desktop/project/course-wiki/`). 아래 명령은 repo 루트에서 실행한다. `HARNESS` 를 이 repo 경로로 둔다.
